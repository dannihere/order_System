...
import com.yu.form.ProductForm;
import com.yu.service.impl.CategoryServiceImpl;
import com.yu.service.impl.ProductServiceImpl;
...
public class SellerProductController {
    ...
    public ModelAndView save(@Valid ProductForm form,
        ...
        try{
            //如果productId为空，说明是新增
            if (!StringUtils.isEmptyOrWhitespaceOnly(form.getProductId())){
